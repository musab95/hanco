...
<br>
<div class="tp-project-section" id="tp-project-section">
  <div class="container">
    <div class="row">
      <div class="col-md-12 tp-heading-title"><!-- tp-hero-unit -->
        <h1>Provides a Wide Range of Products</h1>
      </div>
      <!-- /.tp-hero-unit --> 
    </div>
